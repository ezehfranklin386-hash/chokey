    ...
    <div className="space-y-3">
          ...
          <button
            ...
            className={cn(
              ...
              direction === d.value
                ...
                : 'bg-primary-700 text-white-50 hover:text-white-70 border border-transparent',
            )}
          >
            {d.label}
          </button>
      ...
      <div className="flex flex-wrap items-center gap-3">
        ...
        <div className="relative ml-auto">
          <svg className="absolute left-2.5 top-1/2 h-3 w-3 -translate-y-1/2 text-white-50" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
          ...
          <input
            ...
            className="w-32 rounded-lg border border-primary-500 bg-primary-700 py-1.5 pl-7 pr-2.5 text-xs text-white placeholder-white-50 focus:border-gold-500 focus:outline-none transition-colors"
          />
        </div>
      </div>
    </div>
