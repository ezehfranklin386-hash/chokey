  ...
  if (isLoading) {
    return (
      <div className="rounded-card border border-white-10 bg-primary-800 p-6">
        <h3 className="mb-4 text-sm font-medium text-white-70">Active Signals</h3>
    ...
    return (
      <div className="rounded-card border border-white-10 bg-primary-800 p-6">
        ...
        <div className="flex flex-col items-center justify-center py-8 text-center">
          ...
          <p className="text-sm text-white-70">No active signals</p>
          <p className="mt-1 text-xs text-white-50">Check back later for trading signals</p>
          <button
            onClick={() => navigate('/signals')}
            className="mt-3 text-xs font-medium text-gold-500 hover:text-gold-400 transition-colors"
          >
            Browse Signals →
          </button>
        </div>
  ...
  return (
    <div className="rounded-card border border-white-10 bg-primary-800 p-6">
      <div className="mb-4 flex items-center justify-between">
        <h3 className="text-sm font-medium text-white-70">Active Signals</h3>
        <button
          onClick={() => navigate('/signals')}
          ...
          return (
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-[10px] text-white-30">by {signal.providerName}</p>
              </div>

              {/* Confidence */}
              <div className="text-right shrink-0">
                <div className="text-sm font-mono text-white-90">{signal.confidence}%</div>
