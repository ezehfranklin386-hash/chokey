    ...
    return (
      <div className="rounded-card border border-ink-30/10 dark:border-white-10 bg-white dark:bg-primary-800 p-6">
        ...
        <div className="flex flex-col items-center justify-center py-8 text-center">
          ...
          <p className="text-sm text-ink-70 dark:text-white-70">No assets yet</p>
          <p className="mt-1 text-xs text-ink-50 dark:text-white-50">Deposit or buy crypto to get started</p>
        </div>
      </div>
    );
  }
      ...
      <div className="-mx-2 sm:mx-0 space-y-0.5 sm:space-y-1">
        {wallets.map((wallet) => {
          ...
          return (
            ...
            >
              {/* Icon */}
              <div className="flex h-8 w-8 items-center justify-center rounded-full bg-primary-600 text-sm text-ink-90 dark:text-white-90 font-mono">
                {icon}
              </div>
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-ink-50 dark:text-white-50 font-mono">{wallet.balance} {wallet.asset}</p>
              </div>
